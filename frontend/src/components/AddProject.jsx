    ...
    return (
        <div className="">
            ...
            <form action="projects/new-project" method="post"
                class="w-3/4 max-w-lg mx-auto border rounded border-blue-500 p-4 relative">
                ...
                <button type="submit"
                    class="bg-blue-500 text-white py-2 px-4 rounded border border-blue-500 transition-all hover:bg-transparent hover:text-blue-500">Add</button>
